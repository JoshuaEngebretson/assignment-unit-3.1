...
let favoriteFoods = ['sushi', 'pasta', 'khoresh bademjan', 'roasted potatoes'];
...
console.log('There are',favoriteFoods.length, 'foods in my favorite foods array.');
...
console.log('I ate a new thing, and added a new food to my list', favoriteFoods);
...
favoriteFoods.sort(function reverse(a,b) {
    if ( a < b ) {
        return 1
    }
    if ( a > b ) {
...
console.log('My favorite foods sorted in reverse alphabetical order are,', favoriteFoods);

// 4.g (STRETCH) TODO: Convert your array to a string
//     putting the word "and" between each item.
//     eg "tacos and pizza and pasta". Log the string.
let foodsArray_String = favoriteFoods.join(' and ');
...
let joinedArray = favoriteFoods.concat(animalArray)
